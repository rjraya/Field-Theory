...
\input{galois/galois}
\pagebreak
\section{Elementos primitivos}
\input{primitivo/primitivo}
\pagebreak
\section{Cuerpos finitos}
\input{finito/finito}
\pagebreak
\section{Extensiones ciclotómicas. Raíces de la unidad}
\input{ciclotomico/ciclotomico}
\pagebreak
\section{Norma y traza}
\input{norma/norma}
\pagebreak
\section{Extensiones cíclicas}
\input{ciclicas/ciclicas}
\pagebreak
\section{Extensiones solubles y radicales}
\input{soluble/soluble}
\pagebreak
\section{Grupo de Galois como grupo de permutaciones}
\input{permutaciones/permutaciones}
\pagebreak
